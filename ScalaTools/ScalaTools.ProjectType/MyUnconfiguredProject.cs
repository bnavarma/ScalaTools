...
namespace Microsoft.ScalaTools
{
    ...
    [ProjectTypeRegistration(ScalaPackage.ProjectTypeGuid, "Scala", "#2", ProjectExtension, Language, resourcePackageGuid: ScalaPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    [ProvideProjectItem(ScalaPackage.ProjectTypeGuid, "My Items", @"..\..\Templates\ProjectItems\MyCustomProject", 500)]
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "scalaproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "ScalaTools";

        internal const string Language = "Scala";
