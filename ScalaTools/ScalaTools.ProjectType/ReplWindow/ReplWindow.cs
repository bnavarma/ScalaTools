...
namespace Microsoft.VisualStudio.Repl {
    ...
    class ReplWindow : ToolWindowPane, IOleCommandTarget, IReplWindow3, IVsFindTarget
    {
...
#elif STVS_FEATURE_INTERACTIVEWINDOW
        public const string TypeGuid = "1FA2DB64-FBC1-4F0D-9CCE-32B571EBDA43";
#else
        ...
        private void CreateTextViewHost()
        {
            ...
            IVsTextManager textMgr = (IVsTextManager)ScalaPackage.GetGlobalService(typeof(SVsTextManager));
            var langPrefs = new LANGPREFERENCES[1];
            langPrefs[0].guidLang = LanguageServiceGuid;
            ErrorHandler.ThrowOnFailure(textMgr.GetUserPreferences(null, null, null, null));
