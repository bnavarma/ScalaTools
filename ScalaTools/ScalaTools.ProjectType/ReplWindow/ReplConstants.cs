...
#elif STVS_FEATURE_INTERACTIVEWINDOW
        public const string ReplContentTypeName = "ScalaREPLCode";
        public const string ReplOutputContentTypeName = "ScalaREPLOutput";

        /// <summary>
        /// The additional role found in any REPL editor window.
        /// </summary>
        public const string ReplTextViewRole = "ScalaREPL";
#else
